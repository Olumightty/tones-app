        ...
        <div className='flex flex-col md:flex-row gap-4'>
            <div className='w-[200px] md:w-[300px] flex-col xs:flex-row gap-4 md:flex-col md:max-h-fit md:mr-24'>
                <div className='flex w-[200px]  items-start'>
                    <img className='rounded-xl max-w-[250px] md:max-w-[250px] lg:max-w-[300px]' src={imageUrl} alt={album.data[0]?.attributes?.name} />
                </div>
                <section>
                    <div>
                        <h1 className='text-xl md:text-3xl font-Poppins font-bold text-dullWhite text-wrap  md:max-w-[550px]'>{album.data[0]?.attributes?.name}</h1>
                ...
                <div className='mt-4 '>
                    ...
                    <p className='font-Roboto text-dullWhite  md:max-w-[200px] '><span className='text-grey'>{album.data[0]?.attributes?.copyright}</span></p>
                </div>
            </div>
